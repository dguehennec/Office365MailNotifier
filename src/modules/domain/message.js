...
var EXPORTED_SYMBOLS = ["office365_notifier_Message"];
 ...
 */
var office365_notifier_Message = function(id, timestamp, subject, content, senderMail, convId) {
    this.id = id;
 ...
 */
Object.freeze(office365_notifier_Message);
